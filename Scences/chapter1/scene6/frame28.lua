...
local function nextFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene6.frame29", "fade", 500)
end

local function prevFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene6.frame27", "fade", 500)
end
...
function scene:create( event )
  ...
  imagescene = display.newImageRect("images/chapter1/scene_15-17/scene_16.png", 700,1100)
  ...
  local textCenter = 
  {
      text = "“I find it odd that they would just leave us like that, and the way they obeyed that horn eerie. ” “No questions, no emotion, just plain servitude” \n\n “When we battle them, I manage to look into one of their eyes, it was as if he just was not there in the battle with us.”",     
      x = 193,
      y = 1380,
      width = 700,
