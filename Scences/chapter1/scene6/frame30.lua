...
local function nextFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene6.frame31", "fade", 500)
end
...
function scene:create( event )
  ...
  local textCenter = 
  {
      text = "Leopold beckons you to follow him as he rides faster towards the scent, both of you are then greeted by the sight of an orange sky.\nLeopold - “Flames?” \nAs you get closer to Cliffside, you see the village ablaze with flames leaping out of buildings and engulfing the streets.",     
      x = 193,
      y = 1380,
      width = 700,
