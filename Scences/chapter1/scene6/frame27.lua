...
local function nextFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene6.frame28", "fade", 500)
end
...
function scene:create( event )
  ...
  imagescene = display.newImageRect("images/chapter1/scene_15-17/scene_15.png", 700,1100)
  ...
  local textCenter = 
  {
      text = " In the midst of the battle you hear a deep loud warhorn. The ambushers upon hearing this, retreat and disappear back into the woods. You collect yourself , assess your wounds, get back on your horse and check on Leopold. \n You - “Leopold are you alright?” \n Leopold - “That bolt that hit me still stings, otherwise I am fine”",     
      x = 193,
      y = 1380,
      width = 700,
