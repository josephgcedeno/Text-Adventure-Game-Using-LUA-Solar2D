...
local function prevFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene6.frame30", "fade", 500)
end
...
function scene:create( event )
  ...
  imagescene = display.newImageRect("images/chapter1/scene_15-17/scene_17.png", 700,1100)
  ...
  local textCenter = 
  {
      text = "Yet you do not see a single soul around, no panicked villagers trying to get out of their homes, no one trying to put out the flames,it seemed eerily deserted. \n “Lets approach slowly, there might be another surprise waiting for us like earlier. What do you think?”",     
      x = 193,
      y = 1355,
      width = 700,
  ...
  endcurstory = display.newImageRect("images/chapter1/scene_15-17/current_story_end.png",700,100)
  endcurstory.anchorX = 0
  endcurstory.anchorY = 0
  endcurstory.x, endcurstory.y = 200, 1800
  sceneGroup:insert(endcurstory)
