...
local function nextFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene3.frame7", "fade", 500)
end

local function prevFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene3.frame5", "fade", 500)
end
...
function scene:create( event )
  ...
  local textCenter = 
  {
      text = "“He will pay for what he did all those years ago, leaving us to rot like that while Tevor and Gudram were bleeding”\n\n“They would have made it out if Daemon had not abandoned us like that.”",     
      x = 193,
      y = 1380,
      width = 700,
