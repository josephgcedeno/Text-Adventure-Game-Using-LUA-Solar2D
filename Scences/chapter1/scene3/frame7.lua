...
local function prevFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene3.frame6", "fade", 500)
end

local function choice1Path()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene4.frame8", "fade", 500)
end
...
function scene:create( event )
  ...
  imagescene = display.newImageRect("images/chapter1/scene3/scene_3.png", 700,1100)
  ...
  choice1 = display.newImageRect("images/chapter1/scene3/s3_1st_choice.png",700,100)
  choice1.anchorX = 0
  choice1.anchorY = 0
  ...
  choice2 = display.newImageRect("images/chapter1/scene3/s3_2nd_choice.png",700,100)
  choice2.anchorX = 0
  choice2.anchorY = 0
