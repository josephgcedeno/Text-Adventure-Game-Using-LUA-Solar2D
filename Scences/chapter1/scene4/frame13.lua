...
local function nextFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene4.frame14", "fade", 500)
end
...
function scene:create( event )
  ...
  local textCenter = 
  {
      text = "Bishop - “Yes adventurer? Looking for a job? Kindly refer to the notice board to your left”\n\nLeopold - “You see it has come to my knowledge that you seem to have information I am interested in”\n\n",     
      x = 193,
      y = 1400,
      width = 700,
