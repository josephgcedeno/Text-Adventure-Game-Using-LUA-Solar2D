...
function scene:create( event )
  ...
  imagescene = display.newImageRect("images/chapter1/scene_12/scene_12_2ndchoice.png", 700,1100)
  ...
  local textCenter = 
  {
      text = "Leopold lets loose his bolt and the opponent attempts to dodge to the side but is struck on his side, staggering him. You then rush towards him and strike his head. His body falls to the ground lifeless and gored.",     
      x = 193,
      y = 1450,
      width = 700,
