...
local function nextFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene4.frame9", "fade", 500)
end
...
function scene:create( event )
  ...
  imagescene = display.newImageRect("images/chapter1/scene_4-10/scene_4.png", 700,1100)
  ...
  local textCenter = 
  {
      text = "You and Leopold make preparations, each going through each other’s equipment, you wield a mace on your right hand and buckler on the other with a boot knife for emergencies while Leopold carries a crossbow and a shortsword with a knife strapped to his belt. Both of you still wear the colors of your old unit, a red eye on a black field albeit hidden under your cloaks.",     
      x = 193,
      y = 1380,
      width = 700,
