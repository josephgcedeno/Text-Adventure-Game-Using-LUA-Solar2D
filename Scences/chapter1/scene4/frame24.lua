...
local function prevFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene4.frame23", "fade", 500)
end
local function choice1Path()
  audio.play(sfx_turn)
    composer.gotoScene("Scences.chapter1.scene4.choice1", "fade", 500)
end
local function choice2Path()
  audio.play(sfx_turn)
    composer.gotoScene("Scences.chapter1.scene4.choice2", "fade", 500)
end
local function choice3Path()
  audio.play(sfx_turn)
    composer.gotoScene("Scences.chapter1.scene4.choice3", "fade", 500)
end
...
function scene:create( event )
  ...
  choice1 = display.newImageRect("images/chapter1/scene_11/s11_1st_choice.png",700,100)
  choice1.anchorX = 0
  choice1.anchorY = 0
  choice1.x, choice1.y = 200, 1440
  sceneGroup:insert(choice1)


  choice2 = display.newImageRect("images/chapter1/scene_11/s11_2nd_choice.png",700,100)
  choice2.anchorX = 0
  choice2.anchorY = 0
  choice2.x, choice2.y = 200, 1560
  sceneGroup:insert(choice2)

  choice3 = display.newImageRect("images/chapter1/scene_11/s11_3rd_choice.png",700,100)
  choice3.anchorX = 0
  choice3.anchorY = 0
  choice3.x, choice3.y = 200, 1680
  ...
  choice1:addEventListener("tap",choice1Path)
  choice2:addEventListener("tap",choice2Path)
  choice3:addEventListener("tap",choice3Path)
