...
local function nextFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene4.frame11", "fade", 500)
end
...
function scene:create( event )
  ...
  imagescene = display.newImageRect("images/chapter1/scene_4-10/scene_5.png", 700,1100)
  ...
  local textCenter = 
  {
      text = "As you and Leopold walk the well-maintained and busy streets of the city, you see the Dancing Horse Tavern in front of you where adventurers and mercenaries are congregating, looking for work. \n\n  You make your way through the crowd and enter the tavern where you are greeted by ... ",     
      x = 193,
      y = 1380,
      width = 700,
