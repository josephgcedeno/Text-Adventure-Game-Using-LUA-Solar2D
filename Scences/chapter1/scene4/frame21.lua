...
function scene:create( event )
  ...
  local textCenter = 
  {
      text = " Just as you are about to recover you see four lightly armed men, emerge from the tree lines on both your flanks charge at the both of you with spears. One in particular is closing in fast towards your right flank. ",     
      x = 193,
      y = 1450,
      width = 700,
