...
local function nextFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene4.frame13", "fade", 500)
end
...
function scene:create( event )
  ...
  imagescene = display.newImageRect("images/chapter1/scene_4-10/scene_6.png", 700,1100)
  ...
  local textCenter = 
  {
      text = "Leopold - “Okay follow me, one of the attendants recalls interacting with him, let’s talk to him.”\n\nYou and Leopold approach the attendant on the far right, an old man sits behind the desk in front of you sifting through papers.\n\nLeopold - “Hello there, Bishop is it?”",     
      x = 193,
      y = 1400,
      width = 700,
