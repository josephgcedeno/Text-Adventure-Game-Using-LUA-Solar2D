...
function scene:create( event )
  ...
  imagescene = display.newImageRect("images/chapter1/scene_12/scene_12_3rdchoice.png", 700,1100)
  ...
  local textCenter = 
  {
      text = " His axe is already in the middle of its swing, and catches you in the side, trapping it in your left leg. (Health - 10) As he struggles to recover his weapon, you strike his head with your mace, killing him instantly. \n\n Leopold - “The hell are you doing?”",     
      x = 193,
      y = 1400,
      width = 700,
