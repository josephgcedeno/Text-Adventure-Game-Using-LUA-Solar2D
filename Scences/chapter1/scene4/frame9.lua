...
local function nextFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene4.frame10", "fade", 500)
end
...
function scene:create( event )
  ...
  local textCenter = 
  {
      text = " You follow Leopold out of the inn and into the streets of Pravi.\n\n Pravi is a merchant city state with strong trade ties to the Tenari Empire. The Golden House is the realm’s richest bank where Empires and Kingdoms utilize their services to fund their activities.",     
      x = 193,
      y = 1380,
      width = 700,
