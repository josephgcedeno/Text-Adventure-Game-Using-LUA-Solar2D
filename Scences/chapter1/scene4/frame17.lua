...
local function prevFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene4.frame16", "fade", 500)
end
...
function scene:create( event )
  ...
  imagescene = display.newImageRect("images/chapter1/scene_4-10/scene_8.png", 700,1100)
  ...
  local textCenter = 
  {
      text = "Leopold - “You hear that? King’s way”\n You nod. Leopold then gives a nod to Bishop and beckons you to follow him outside. \n Leopold - “Cliffside? That area is barren and full of squalor and King’s way is a curious destination” \n ",     
      x = 193,
      y = 1400,
      width = 700,
