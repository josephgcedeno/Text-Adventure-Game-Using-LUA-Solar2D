...
local function nextFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene4.frame12", "fade", 500)
end
...
function scene:create( event )
  ...
  local textCenter = 
  {
      text = " ... the familiar stench of urine and alcohol followed by the familiar sounds of debauchery. In front you is a notice board where more adventurer’s have thronged, looking for work. Beside it are the four attendants of the notice board. ",     
      x = 193,
      y = 1400,
      width = 700,
