...
local function nextFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene4.frame21", "fade", 500)
end

local function prevFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene4.frame19", "fade", 500)
end
...
function scene:create( event )
  ...
  imagescene = display.newImageRect("images/chapter1/scene_4-10/scene_10.png", 700,1100)
  ...
  local textCenter = 
  {
      text = "You then see a tree falling in front of you blocking your path forward and frightening the horses. Then another tree to your rear immediately follows suit, trapping the both of you in between the fallen logs. \nYour mounts rear and in a split second Leopold is hit by a quarrel that grazes his right shoulder, staggering him but fails to dismount him.",     
      x = 193,
      y = 1380,
      width = 700,
