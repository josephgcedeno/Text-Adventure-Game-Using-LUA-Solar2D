...
local function nextFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene4.frame20", "fade", 500)
end

local function prevFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene4.frame18", "fade", 500)
end
...
function scene:create( event )
  ...
  imagescene = display.newImageRect("images/chapter1/scene_4-10/scene_9.png", 700,1100)
  ...
  local textCenter = 
  {
      text = "You go to the city stables and retrieve your destrier, you both mount on your horses and make haste towards Cliffside. \n On the fourth day of your journey, as you and Leopold are nearing Cliffside village, both of you hear a sudden whistle and a rustle of the leaves. \n Leopold - “What was that?” \n “That sounded awfully close.”",     
      x = 193,
      y = 1390,
      width = 700,
