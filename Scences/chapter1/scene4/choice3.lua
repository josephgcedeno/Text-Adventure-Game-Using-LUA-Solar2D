...
local function nextFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene4.choice3_cont", "fade", 500)
end
...
function scene:create( event )
  ...
  local textCenter = 
  {
      text = "You decide to do nothing as the man with the lumber axe rushes towards your left flank, attempting to use you as cover from Leopold’s bolts. Leopold is unable to fire and shifts his attention to the enemies on the right flank. You face towards him, but it's too late.",     
      x = 193,
      y = 1400,
      width = 700,
