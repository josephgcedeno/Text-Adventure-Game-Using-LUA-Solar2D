...
function scene:create( event )
  ...
  local textCenter = 
  {
      text = "Leopold is able to recover his steed and rushes towards the enemy to your right flank, displacing him but failing to damage him. Leopold quickly goes to your side where you both have each other’s flanks.",     
      x = 193,
      y = 1450,
      width = 700,
