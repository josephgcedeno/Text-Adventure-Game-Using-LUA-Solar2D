...
local function nextFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene4.frame17", "fade", 500)
end

local function prevFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene4.frame15", "fade", 500)
end
...
function scene:create( event )
  ...
  imagescene = display.newImageRect("images/chapter1/scene_4-10/scene_7.png", 700,1100)
  ...
  local textCenter = 
  {
      text = "Bishop - “I was thinking of dragonskin boots ”\nLeopold sighs and shakes Bishop's hand again where he discreetly hands him another coin pouch. Bishop lets out a smile after feeling the amount of coins in the pouch.\nLeopold - “This better be good” \nBishop - “The job was a simple caravan escort from Cliffside to King’s way”",     
      x = 193,
      y = 1390,
      width = 700,
