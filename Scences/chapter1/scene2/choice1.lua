...
function scene:create( event )
  ...
  local textCenter = 
  {
      text = "Leopold - “I see, you have been having the same nightmare since that time right?”\n\n “It's hard to believe that it's been five years since that time, I miss them.Bloody hell, I don't even want to think about that hell again. ”",     
      x = 193,
      y = 1380,
      width = 700,
