...
function scene:create( event )
  ...
  local textCenter = 
  {
      text = "Leopold - “If it's the same nightmare, then I can't blame you for forgetting”\n\n “It's hard to believe that it's been five years since that time, I miss them. Damn, I don't even want to think about that hell again.",     
      x = 193,
      y = 1380,
      width = 700,
