...
local function nextFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene2.frame4", "fade", 500)
end
...
function scene:create( event )
  ...
  local textCenter = 
  {
      text = "You  soon grow paranoid, as the air grows still making it difficult to breath, your chest pounds and your vision darken, you wake up. \n\n Leopold -” Finally awake?  Is it that dream again?”",     
      x = 193,
      y = 1380,
      width = 700,
