...
local function nextFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene5.frame26", "fade", 500)
end
...
function scene:create( event )
  ...
  local textCenter = 
  {
      text = "After you defeat him, you immediately turn towards the enemies closing on Leopold, he struggles against the first spearman lunging at him, skillfully parrying and successfully grabbing the spearhead, he shouts at you to take advantage of the opportunity.",     
      x = 193,
      y = 1380,
      width = 700,
