...
local function prevFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene5.frame25", "fade", 500)
end
local function choice1Path()
  audio.play(sfx_turn)
    composer.gotoScene("Scences.chapter1.scene5.choice1", "fade", 500)
end
local function choice2Path()
  audio.play(sfx_turn)
    composer.gotoScene("Scences.chapter1.scene5.choice2", "fade", 500)
end
...
function scene:create( event )
  ...
  imagescene = display.newImageRect("images/chapter1/scene_13/scene_13.png", 700,1100)
  imagescene.anchorX = 0
  imagescene.anchorY = 0
  imagescene.x, imagescene.y = 200, 250
  sceneGroup:insert(imagescene)

  choice1 = display.newImageRect("images/chapter1/scene_13/s11_1st_choice.png",700,100)
  choice1.anchorX = 0
  choice1.anchorY = 0
  choice1.x, choice1.y = 200, 1470
  sceneGroup:insert(choice1)


  choice2 = display.newImageRect("images/chapter1/scene_13/s13_2nd_choice.png",700,100)
  choice2.anchorX = 0
  choice2.anchorY = 0
  choice2.x, choice2.y = 200, 1590
