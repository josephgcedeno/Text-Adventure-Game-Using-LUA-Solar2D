...
function scene:create( event )
  ...
  local textCenter = 
  {
      text = "As your back hits the ground, you quickly try to recover, but just as you are able to get back on your feet, you are immediately jabbed on the chest by the spearman.",     
      x = 193,
      y = 1450,
      width = 700,
