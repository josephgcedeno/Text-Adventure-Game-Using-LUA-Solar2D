...
local function nextFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene5.choice2_cont", "fade", 500)
end
...
function scene:create( event )
  ...
  imagescene = display.newImageRect("images/chapter1/scene_14/scene_14_2nd_choice.png", 700,1100)
  ...
  local textCenter = 
  {
      text = "Leopold is forced to disengage and gallops towards the left side, you then see the spearman change his target and immediately jabs his spear towards your horse, sending you mount rearing, throwing you off your horse.\n\n Leopold - “NO!!”",     
      x = 193,
      y = 1380,
      width = 700,
