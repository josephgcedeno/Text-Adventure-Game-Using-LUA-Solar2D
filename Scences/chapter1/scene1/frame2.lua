...
function scene:create( event )
  ...
  imagescene = display.newImageRect("images/chapter1/scene1/scene_1.png", 700,1100)
  ...
  local textCenter = 
  {
      text = " You see a fork in the path before you, upon first sight of it, there is nothing of note that would otherwise lead you to the correct path.",     
      x = 193,
      y = 1380,
      width = 700,
  ...
  leftpath = display.newImageRect("images/chapter1/scene1/s1_1stchoice.png",700,100)
  leftpath.anchorX = 0
  leftpath.anchorY = 0
  leftpath.x, leftpath.y = 200, 1600
  sceneGroup:insert(leftpath)


  rightpath = display.newImageRect("images/chapter1/scene1/s1_2ndchoice.png",700,100)
  rightpath.anchorX = 0
  rightpath.anchorY = 0
  rightpath.x, rightpath.y = 200, 1720
  sceneGroup:insert(rightpath)
  ...
  leftpath:addEventListener("tap",leftPath)
  rightpath:addEventListener("tap",rightPath)
