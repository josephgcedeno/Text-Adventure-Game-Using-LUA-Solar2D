...
local function nextFrame()
  audio.play(sfx_turn)
  composer.gotoScene("Scences.chapter1.scene1.frame2", "fade", 500)
end
...
function scene:create( event )
  ...
  local textCenter = 
  {
      text = "A dark cavern beckons you in the night, whispering in your ear \"come here\".You approach the cavernous opening where you feel as if some malevolent force compels you to go deeper. As you tread carefully through the tunnels, you can’t help but feel as if someone or something is watching you.",     
      x = 193,
      y = 1380,
      width = 700,
